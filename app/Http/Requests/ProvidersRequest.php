...
class ProvidersRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            'mail' => ['nullable', 'email', 'min:10', $id ? Rule::unique('providers')->ignore($id) : Rule::unique('providers')],
    ...
    public function messages()
    {
        return [
            ...
            'mail.email' => 'El correo debe tener un formato valido',
            'mail.min' => 'El correo debe tener minimo 10 caracteres de longitud',
            'mail.unique' => 'El correo ingresado ya esta registrado',
